...
def match_model():
    ...
    combine = Concatenate()([image_embedding, text_embedding]) #combine the models outputs
    dense = Dense(64, activation='relu', kernel_regularizer=l2(0.01))(combine)  #Fully connected layer
    output = Dense(1, activation='sigmoid')(dense) #Decision layer
